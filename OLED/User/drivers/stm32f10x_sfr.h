...
#define GPIOA_PIN_0   (1<<0)
#define GPIOA_PIN_1   (1<<1)
#define GPIOA_PIN_2   (1<<2)
#define GPIOA_PIN_3   (1<<3)
#define GPIOA_PIN_4   (1<<4)
#define GPIOA_PIN_5   (1<<5)
#define GPIOA_PIN_6   (1<<6)
#define GPIOA_PIN_7   (1<<7)
#define GPIOA_PIN_8   (1<<8)
#define GPIOA_PIN_9   (1<<9)
#define GPIOA_PIN_10  (1<<10)
#define GPIOA_PIN_11  (1<<11)
#define GPIOA_PIN_12  (1<<12)
#define GPIOA_PIN_13  (1<<13)
#define GPIOA_PIN_14  (1<<14)
#define GPIOA_PIN_15  (1<<15)
