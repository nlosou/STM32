...
#define OPEN_TIM2() (*(volatile uint32_t*)(TIM2_TIMER_BASE + 0x00)|=0x01)
#define CLOSE_TIM2() (*(volatile uint32_t*)(TIM2_TIMER_BASE + 0x00)&=~0x01)
#define CLOSE_TIM3() (*(volatile uint32_t*)(TIM3_TIMER_BASE + 0x00)&=~0x01)
#define CLEAR_TIM2_CNT()  (*(volatile uint32_t*)(TIM2_TIMER_BASE + 36) = 0x00)
#define TIMER_SET_TIM2_ARR(x)   (*(volatile uint32_t*)(TIM2_TIMER_BASE + 44) = x - 1)
